...
public class DummyRequest extends Request {
    ...
    // The following methods are stubs that throw exceptions.
    ...
    @Override public void attribute(String attribute, Object value) { throw new UnsupportedOperationException(); }
