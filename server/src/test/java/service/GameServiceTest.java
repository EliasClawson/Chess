...
public class GameServiceTest {
    ...
    public void testCreateGameInvalidAuth() throws Exception {
    ...
    public void testListGamesPositive() throws Exception {
        ...
        // Expect exactly 2 games since we cleared the table in setUp.
    ...
    public void testJoinGameInvalidAuth() throws Exception {
    ...
    public void testJoinGameSlotTaken() throws Exception {
